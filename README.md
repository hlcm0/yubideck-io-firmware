...
3.Download boards.txt from this repository and put it in C:\Users\Administrator\AppData\Local\Arduino15\packages\rp2040\hardware\rp2040\2.6.4<br>
...
1.Changing the VID and PID of the Raspberry Pi Pico to 0x1973 and 0x2001 to make it the same as Yubideck controller.(So that the IO would regard the pico as a Yubideck)<br>
2.Changing the Manufacture name to "ZHOUSENSOR I/O SYSTEM" and changing the product name to "ZhouSensor YubiDeck" (But actually not so important)<br>
